                    ...
                    [
                        html.Div(
                            children=[
                                ...
                                html.Span("The x-axis shows the Frequency score of the word in the selected block and the y-axis shows the Inverse Document Frequency score, where 1/3 means the word occurs in 1 of 3 blocks over the document. "),
                                html.Span("When the mouse is moved over the word, the total TF-IDF score can be seen and again the two individual scores "),
