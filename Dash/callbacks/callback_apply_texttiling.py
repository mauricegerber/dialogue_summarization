...
def callback_apply_texttiling(app, transcripts):
    @app.callback(
        ...
        Output(component_id="texttiling_table", component_property="columns"),
        Output(component_id="texttiling_table", component_property="style_cell_conditional"),
    ...
    def apply_texttiling(n_clicks, selected_transcript, selected_language,
                         ...
                         selected_methods, tfidf_n_kws, tfidf_method,
