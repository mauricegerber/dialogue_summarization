...
def segmentation_score(timestamp1, timestamp2):
    ...
    print(d1, d2)
    return round(np.median(d1+d2),2)
...
test2 = ["00:00", "19:34", "45:08", "47:12"]

# test1 = ["00:00", "19:34", "34:39", "41:44", "45:08", "47:12"]
# test2 = ["00:00", "07:21", "37:32", "47:12"]

test1 = ["00:00", "12:53", "17:37", "22:06", "32:36", "41:09", "44:21"]
test2 = ["00:00", "17:58", "21:51", "30:41", "32:26", "37:08", "44:21"]
